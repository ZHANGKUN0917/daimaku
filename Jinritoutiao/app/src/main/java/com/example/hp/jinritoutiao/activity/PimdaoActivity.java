...
import com.example.hp.jinritoutiao.view.MyGridView;

import java.util.ArrayList;
import java.util.List;

public class PimdaoActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pimdao);
         initView();
    }
        ...
        switch (adapterView.getId()) {
            case R.id.userGridView:
                ...
                if (i != 0 && i != 1) {
                    ...
                    if (moveImageView != null) {
                        ...
                        final String channel = ((OtherAdapter) adapterView.getAdapter()).getItem(i);//获取点击的频道内容
            ...
            case R.id.otherGridView:
                ...
                if (moveImageView != null) {
                    ...
                    final int[] startLocation = new int[2];
                    newTextView.getLocationInWindow(startLocation);
                    final String channel = ((OtherAdapter) adapterView.getAdapter()).getItem(i);
